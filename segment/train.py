...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='C:/Users/zyq/Desktop/yolov5-7.0/models/segment/yolov5s-seg.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/dog-seg.yaml', help='dataset.yaml path')
